...
class UserModel extends Database
{
    ...
    public
    function insertUser($status, $login, $zip, $email, $hashedpassword)
    {
    ...
    public
    function updateUser($status, $login, $zip, $email, $hashedpassword, $id)
    {
    ...
    public
    function selectVendeurArticles($id)
    {
    ...
    public
    function selectVendeurArticlesSold($id)
    {
    ...
    public
    function marquerCommeVendu($idAcheteur, $id)
    {
    ...
    public
    function updateArticle($titre, $description, $prix, $etat, $categorie, $negociation, $id)
    {
    ...
    public
    function insertArticle($titre, $description, $prix, $etat, $categorie, $negociation, $idUser)
    {
    ...
    public
    function insertArticleAModerer($titre, $description, $prix, $etat, $negociation, $catSuggeree, $idUser, $visible)
    {
    ...
    public
    function selectMessagesConversation($idDestinataire, $idUser)
    {
    ...
    public
    function sendNewMessage($idDestinataire, $idUser, $messageContent)
    {
